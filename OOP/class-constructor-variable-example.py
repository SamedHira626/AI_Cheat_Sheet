...
class Calisan:
    ...
    def __init__(self,isim,soyisim,maas): # constructor
        ...
        self.counter2 = self.counter2 + 1   #bunu yaparsan her çalışan için count = 1 olur, Calisan sınıfının counterini artırmak için aşağıdaki gibi 
